...
set_case_metadata() {
     ...
     CASE_COMB_CMD="./comb 512_512_512 -divide 2_2_1 -periodic 1_1_1 -ghost 8_8_8 -vars 3 -comm cutoff 250 -comm enable mpi -comm post_recv wait_all -comm post_send wait_all -comm wait_recv ${wait_mode} -comm wait_send ${wait_mode} -exec enable omp -print_message_sizes -print_packing_sizes"
...
#salloc -M inter -p cm4_inter -N 2 -n 4 --ntasks-per-node=2 -c 4 -t 01:30:00
#bash run_1.sh